                ...
                <div className="md:w-[67%] lg:w-[40%] w-full lg:ml-20">
                    <form >
                        ...
                        <div className="flex flex-row justify-between flex-wrap mb-6">
                            <p className="text-md sm:text-sm">Don't hava  a account?<Link to={"/sign-up"} className="ml-1 text-red-500 hover:text-red-600 hover:font-bold duration-200 ease-in">Rigister</Link></p>
                            <Link to={"/forgot-password"} className="text-md sm:text-sm text-blue-600 hover:text-blue-700 hover:font-bold duration-200 ease-in">Forget password?</Link>
                        </div>
                        <button
                            type="submit"
